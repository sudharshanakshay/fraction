...
class SignInPageState extends State<SignInPage> {
  ...
  build(context) {
    return Consumer<ApplicationState>(
      builder: (context, appState, _) => appState.loggedIn ? const MyHomePage(title: 'Fraction',) :
       Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              CustomInputFormField( controller: _passwordStringController, label: 'Password', obsecure: true,),
              FractionallySizedBox(
                widthFactor: 0.8,
                child: FilledButton(
                    onPressed: () {
                      appState.emailSignInUser(_emailStringController.text,
